...
private String CategoryName,Description,Price,Pname,saveCurrentDate,saveCurrentTime;
    ...
    private DatabaseReference ProductsRef;//same as in login activity to get reference to the database
    ...
    private void StoreProductInformation() {
        ...
        loadingBar.setMessage("Please Wait,new product is being added");
